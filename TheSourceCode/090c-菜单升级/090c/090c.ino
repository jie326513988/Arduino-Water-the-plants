...
const uint8_t sb_i1 = 6;          //电机驱动输入引脚1
const uint8_t sb_i2  = 5;         //电机驱动输入引脚2
const uint8_t cgq_vcc = 12;       //传感器电源正极
const uint8_t led = 13;           //led指示灯（暂时未启用）
const uint8_t up = 2;             //上按键
const uint8_t down = 3;           //下按键
const uint8_t confirm = 4;        //确认按键
const uint8_t vcc_read  = A3;     //读取电压的引脚
const uint8_t trsd_read  = A0;    //读取土壤湿度的引脚
const uint8_t cd_read  = A2;      //读取充电状态的引脚
...
volatile boolean sb_error = 0;     //水泵错误计数
