/* 版本更新说明
    ...
    修改设置界面的数值排序
    092c
    1.优化按键的算法，取消delay延时的方式消抖，改用时间对比的方式
    091c
...
void setup()
{
  ...
  analogWrite(moto_input_1, 0);
  analogWrite(moto_input_2, 0);
