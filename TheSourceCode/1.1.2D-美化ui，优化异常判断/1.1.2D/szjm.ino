...
void szjm_0_2p()   //第2页,不带刷新
{
  u8g2.setCursor(1, 14);
  u8g2.print("土壤传感器");
  u8g2.setCursor(112, 14);
  if (cgq_sw_state == 1) u8g2.print("开");
  else u8g2.print("关");
  ...
  u8g2.setCursor(1, 46);
  u8g2.print("水泵接口");
  u8g2.setCursor(95, 46);
  if (sbjkfz_set_state == 0) u8g2.print("L+R-");
  else u8g2.print("L-R+");
...
void szjm_1() //画选框-浇水上限
{
  ...
  do {
    u8g2.setDrawColor(2);
    szjm_0_1p();
    if (szjm_xk_count == 0)  u8g2.drawBox(0, 0, 128, 16); //实心方形
    else if (szjm_xk_count == 1)  u8g2.drawFrame(0, 0, 127, 17); //空心方形
    u8g2.setDrawColor(1);
  } while ( u8g2.nextPage() );
}
...
void szjm_2()  //画选框-浇水下限
{
  ...
  do {
    u8g2.setDrawColor(2);
    szjm_0_1p();
    if (szjm_xk_count == 0) u8g2.drawBox(0, 16, 128, 16); //实心方形
    else if (szjm_xk_count == 2) u8g2.drawFrame(0, 16, 128, 17); //空心方形
    u8g2.setDrawColor(1);
  } while ( u8g2.nextPage() );
}
...
void szjm_3()  //画选框-休眠时间
{
  ...
  do {
    u8g2.setDrawColor(2);
    szjm_0_1p();
    if (szjm_xk_count == 0) u8g2.drawBox(0, 32, 128, 16); //实心方形
    else if (szjm_xk_count == 3) u8g2.drawFrame(0, 32, 127, 17); //空心方形
    u8g2.setDrawColor(1);
  } while ( u8g2.nextPage() );
}
...
void szjm_6()  //画选框-水泵超时时间
{
  ...
  do {
    ...
    szjm_0_2p();
    if (szjm_xk_count == 0) u8g2.drawBox(0, 16, 128, 16); //实心方形
    else if (szjm_xk_count == 6) u8g2.drawFrame(0, 16, 127, 17); //空心方形
    u8g2.setDrawColor(1);
  } while ( u8g2.nextPage() );
}
...
void szjm_8() //画选框-电压校准
{
  ...
  do {
    u8g2.setDrawColor(2);
    szjm_0_2p();
    if (szjm_xk_count == 0) u8g2.drawBox(0, 48, 128, 16); //实心方形
    else if (szjm_xk_count == 8) u8g2.drawFrame(0, 48, 127, 16); //空心方形
    u8g2.setDrawColor(1);
  } while ( u8g2.nextPage() );
}
